...
-- Make line numbers default, also relative line numbers
vim.opt.number = true
...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      --
      --    How to install specific LSP? Simply run :LSPInstall
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- The following ode creates a keymap to toggle inlay hints in your
